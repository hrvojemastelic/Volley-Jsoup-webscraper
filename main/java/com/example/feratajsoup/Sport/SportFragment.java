package com.example.feratajsoup.Sport;
...
public class SportFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String url = "http://www.ferata.hr/kategorija/sport/";
    ...
    private void init() {
        ...
        recyclerView=(RecyclerView)v.findViewById(R.id.rcsport);
        ...
        swipeRefreshLayout =(SwipeRefreshLayout)v.findViewById(R.id.swipesport);
    }
